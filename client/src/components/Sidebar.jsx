...
const Sidebar = ({ onLogout, open, setOpen, role = "Admin" }) => {
  ...
  const links =
    role === "Admin"
      ? [
          ...
          { to: "/admin/leaves", label: "Leave Requests", icon: <FaEnvelopeOpenText /> },
          { to: "/admin/tasks/create", label: "Assign Task", icon: <FaTasks /> },
  ...
  return (
    <div
      className={`bg-black text-white h-screen fixed flex flex-col ${
        open ? "w-64" : "w-16"
